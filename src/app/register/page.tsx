    ...
    <Container maxW="container.xl" minH="100vh" display="flex" alignItems="center" justifyContent="center">
      <Flex w="full" maxW="400px" direction="column">
        ...
        <Box bg="white" p={8} borderRadius="2xl" shadow="lg" border="1px" borderColor="gray.100">
          ...
          <Text color="gray.500" mb={6}>Start your call tracking journey</Text>
          <form onSubmit={handleSubmit}>
            <VStack spacing={4}>
              ...
              <Button type="submit" colorScheme="primary" w="full" size="lg" isLoading={loading}>Create Account</Button>
            </VStack>
          </form>
          <Text textAlign="center" mt={4} color="gray.500" fontSize="sm">
            Already have an account? <Link href="/login" color="primary.500" fontWeight="medium">Sign in</Link>
          </Text>
